...
public class UpdateHandlerTest extends AbstractTestBase {
    ...
    public void testUpdate_OptInManagedAdminPassword() {
        ...
        assertThat(response.getResourceModel().getAdminPasswordSecretArn()).isEqualTo(SECRET_ARN);
    ...
    public void testUpdate_OptOutManagedAdminPassword() {
        ...
        assertThat(response.getResourceModel().getAdminPasswordSecretArn()).isNull();
